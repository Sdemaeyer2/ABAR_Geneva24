...
Part 2: Reporting and interpreting Bayesian models (Pt. 1)

Part 3: Reporting and interpreting Bayesian models (Pt. 2) + Checking the model with the WAMBS and how to do it in `R`

Part 4: Analysing your own data

## Practical stuff

All material is on a shared Dropbox folder called [ABAR_Geneva24]{style="color: #447099"}

You can find:

-   Folder [Presentations]{style="color: #447099"}

-   Sub-folders for each part of the workshop

-   With files called [Slides_Part1.html]{style="color: #447099"} (presentation you can open) and [Slides_Part1.qmd]{style="color: #447099"} (source quarto file)
...
-   in 95% of similar samples from that population the estimate would be between `r lower` and `r higher`
