...
All materials for the course can be downloaded via <a href="https://github.com/Sdemaeyer2/ABAR_Geneva24" target="_blank">the github page </a>. 
...
A powerfull way to visualize the effects of (mixed effects) regression models, is to plot <i>Hypothetical Outcome Plots</i>. These type of plots need a considerable amount of coding. Therefore, we provide two R-scripts that can be used as a starting point to plot your own results:
